...
if ($LASTEXITCODE -eq 0) {
    ...
    & $GCLOUD_PATH storage rsync ./public gs://lricbc-web-storage/public --recursive --project $PROJECT_ID --exclude "public/gallery/**" --exclude "public/gallery/metadata.sample.json"
